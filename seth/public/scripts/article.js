...
(function(module) {
  ...
  */
  ...
  Article.numWordsAll = () => {
    return Article.all.map(articleObject => articleObject.body.length).reduce((a,b) => a + b);
  };
  ...
  Article.prototype.insertRecord = function(callback) {
    // REVIEW: Why can't we use an arrow function here for .insertRecord()? It has a this in it and arrow functions don't have a contextual this! It won't know what this is.
